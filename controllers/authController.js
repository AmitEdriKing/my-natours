...
//to get acces to variables in middleware need to wrap middleware function with a function with variables
exports.restrictTo = (...roles) => {
  return (req, res, next) => {
    //roles is an array [admin,lead-guide]. role="user"
    //req.user.role is encoded in protect middleware in line req.user = currentUser;
...
exports.forgotPassword = catchAsync(async (req, res, next) => {
  //1)get user based by posted email
  ...
  //{ validateBeforeSave: false } for not validate all the fieldsin the schema like passwordChange
